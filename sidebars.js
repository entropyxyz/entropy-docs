export default {
  ...
  sidebar: [
    ...
    },
    {
      ...
      label: 'Guides',
      items: [
        { type: 'doc', id: 'guides/example', label: 'Create a wallet' },
        { type: 'doc', id: 'guides/example', label: 'Register an address' },
        { type: 'doc', id: 'guides/example', label: 'Deploy a program' },
        { type: 'doc', id: 'guides/example', label: 'Query the chain' },
      ],
    },
    {
      type: 'category',
